        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          >
            {success ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-[#0F2C59] font-bold text-2xl mb-2">{t('booking_success_title')}</h3>
                <p className="text-gray-500 text-sm mb-6">
                  {t('booking_success_text').replace('{name}', form.name).replace('{destination}', form.destination)}
                </p>
                <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="">{t('placeholder_destination')}</option>
                        {DESTINATIONS.map((d) => (
          ...
          >
            <div className="bg-[#0F2C59] rounded-2xl p-5 text-white">
              <h3 className="font-bold text-base mb-1">{t('why_book_title')}</h3>
              <p className="text-white/60 text-xs mb-4">{t('why_book_subtitle')}</p>
              {[
                t('benefit_price'),
                t('benefit_cancel'),
                t('benefit_support'),
            ...
            <div className="bg-[#C9952A]/10 border border-[#C9952A]/20 rounded-2xl p-5">
              <p className="text-[#0F2C59] font-bold text-sm mb-1">{t('whatsapp_card_title')}</p>
              <p className="text-gray-500 text-xs mb-3">
                {t('whatsapp_card_text')}
              </p>
              <a
            ...
            <div className="bg-[#F8F6F1] rounded-2xl p-5 border border-gray-100">
              <p className="text-[#0F2C59] font-bold text-sm mb-3">{t('call_title')}</p>
              <a
              ...
              <p className="text-gray-400 text-xs mt-1">{t('call_hours')}</p>
            </div>
          </motion.div>
        </div>
      </div>
